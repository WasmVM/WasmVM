...
void Instruction::f32_eq(Stack& coreStack) {
  ...
  if (Util::isNaN(operand1->data.f32) || Util::isNaN(operand2->data.f32)) {
    coreStack.push(Value((std::int32_t)0));
  } else if (Util::isZero(operand1->data.f32) &&
             Util::isZero(operand1->data.f32)) {
    coreStack.push(Value((std::int32_t)1));
...
void Instruction::f64_eq(Stack& coreStack) {
  ...
  if (Util::isNaN(operand1->data.f64) || Util::isNaN(operand2->data.f64)) {
    coreStack.push(Value((std::int32_t)0));
  } else if (Util::isZero(operand1->data.f64) &&
             Util::isZero(operand1->data.f64)) {
    coreStack.push(Value((std::int32_t)1));
...
void Instruction::i32_clz(Stack& coreStack) {
  ...
  if (operand->data.i32 == 0) {
    ...
    std::int32_t n = 0;
    if (!(operand->data.i32 & 0xFFFF0000)) {
      n += 16;
      operand->data.i32 <<= 16;
    }
    if (!(operand->data.i32 & 0xFF000000)) {
      n += 8;
      operand->data.i32 <<= 8;
    }
    if (!(operand->data.i32 & 0xF0000000)) {
      n += 4;
      operand->data.i32 <<= 4;
    }
    if (!(operand->data.i32 & 0xC0000000)) {
      n += 2;
      operand->data.i32 <<= 2;
    }
    if (!(operand->data.i32 & 0x80000000)) {
      n += 1;
      operand->data.i32 <<= 1;
    }
...
void Instruction::i32_ctz(Stack& coreStack) {
  ...
  if (operand->data.i32 == 0) {
    ...
    std::int32_t n = 0;
    if (!(operand->data.i32 & 0x0000FFFF)) {
      n += 16;
      operand->data.i32 >>= 16;
    }
    if (!(operand->data.i32 & 0x000000FF)) {
      n += 8;
      operand->data.i32 >>= 8;
    }
    if (!(operand->data.i32 & 0x0000000F)) {
      n += 4;
      operand->data.i32 >>= 4;
    }
    if (!(operand->data.i32 & 0x00000003)) {
      n += 2;
      operand->data.i32 >>= 2;
    }
    if (!(operand->data.i32 & 0x00000001)) {
      n += 1;
      operand->data.i32 >>= 1;
    }
    coreStack.push(Value(n));
...
void Instruction::i32_popcnt(Stack& coreStack) {
  ...
  // popcnt
  operand->data.i32 = (operand->data.i32 & 0x55555555) +
                      ((operand->data.i32 >> 1) & 0x55555555);
  operand->data.i32 = (operand->data.i32 & 0x33333333) +
                      ((operand->data.i32 >> 2) & 0x33333333);
  operand->data.i32 = (operand->data.i32 & 0x0F0F0F0F) +
                      ((operand->data.i32 >> 4) & 0x0F0F0F0F);
  operand->data.i32 = (operand->data.i32 & 0x00FF00FF) +
                      ((operand->data.i32 >> 8) & 0x00FF00FF);
  operand->data.i32 = (operand->data.i32 & 0x0000FFFF) +
                      ((operand->data.i32 >> 16) & 0x0000FFFF);
...
void Instruction::i32_rotl(Stack& coreStack) {
  ...
  coreStack.push((std::int32_t)((val << operand2->data.i32) |
                                (val >> (32 - operand2->data.i32))));
  // Clean
  delete operand1;
  delete operand2;
}
...
void Instruction::i64_clz(Stack& coreStack) {
  ...
  if (operand->data.i64 == 0) {
    ...
    std::int64_t n = 0;
    if (!(operand->data.i64 & 0xFFFFFFFF00000000)) {
      n += 32;
      operand->data.i64 <<= 32;
    }
    if (!(operand->data.i64 & 0xFFFF000000000000)) {
      n += 16;
      operand->data.i64 <<= 16;
    }
    if (!(operand->data.i64 & 0xFF00000000000000)) {
      n += 8;
      operand->data.i64 <<= 8;
    }
    if (!(operand->data.i64 & 0xF000000000000000)) {
      n += 4;
      operand->data.i64 <<= 4;
    }
    if (!(operand->data.i64 & 0xC000000000000000)) {
      n += 2;
      operand->data.i64 <<= 2;
    }
    if (!(operand->data.i64 & 0x8000000000000000)) {
      n += 1;
      operand->data.i64 <<= 1;
    }
    coreStack.push(Value(n));
...
void Instruction::i64_ctz(Stack& coreStack) {
  ...
  if (operand->data.i64 == 0) {
    ...
    std::int64_t n = 0;
    if (!(operand->data.i64 & 0x00000000FFFFFFFF)) {
      n += 32;
      operand->data.i64 >>= 32;
    }
    if (!(operand->data.i64 & 0x000000000000FFFF)) {
      n += 16;
      operand->data.i64 >>= 16;
    }
    if (!(operand->data.i64 & 0x00000000000000FF)) {
      n += 8;
      operand->data.i64 >>= 8;
    }
    if (!(operand->data.i64 & 0x000000000000000F)) {
      n += 4;
      operand->data.i64 >>= 4;
    }
    if (!(operand->data.i64 & 0x0000000000000003)) {
      n += 2;
      operand->data.i64 >>= 2;
    }
    if (!(operand->data.i64 & 0x0000000000000001)) {
      n += 1;
      operand->data.i64 >>= 1;
    }
    coreStack.push(Value(n));
...
void Instruction::i64_popcnt(Stack& coreStack) {
  ...
  // popcnt
  operand->data.i64 = (operand->data.i64 & 0x5555555555555555) +
                      ((operand->data.i64 >> 1) & 0x5555555555555555);
  operand->data.i64 = (operand->data.i64 & 0x3333333333333333) +
                      ((operand->data.i64 >> 2) & 0x3333333333333333);
  operand->data.i64 = (operand->data.i64 & 0x0F0F0F0F0F0F0F0F) +
                      ((operand->data.i64 >> 4) & 0x0F0F0F0F0F0F0F0F);
  operand->data.i64 = (operand->data.i64 & 0x00FF00FF00FF00FF) +
                      ((operand->data.i64 >> 8) & 0x00FF00FF00FF00FF);
  operand->data.i64 = (operand->data.i64 & 0x0000FFFF0000FFFF) +
                      ((operand->data.i64 >> 16) & 0x0000FFFF0000FFFF);
  operand->data.i64 = (operand->data.i64 & 0x00000000FFFFFFFF) +
                      ((operand->data.i64 >> 32) & 0x00000000FFFFFFFF);
  coreStack.push(*operand);
  // clean
  delete operand;
}
...
void Instruction::i64_rotl(Stack& coreStack) {
  ...
  coreStack.push((std::int64_t)((val << operand2->data.i64) |
                                (val >> (64 - operand2->data.i64))));
  // Clean
  delete operand1;
  delete operand2;
}
...
void Instruction::f32_abs(Stack& coreStack) {
  ...
  // abs
  coreStack.push(Util::isPos(operand->data.f32) ? operand->data.f32
                                                : -operand->data.f32);
  // Clean
  delete operand;
}
...
void Instruction::f32_ceil(Stack& coreStack) {
  ...
  // ceil
  if (Util::isNaN(operand->data.f32) || Util::isInf(operand->data.f32) ||
      Util::isZero(operand->data.f32)) {
    coreStack.push(operand->data.f32);
...
void Instruction::f32_sqrt(Stack& coreStack) {
  ...
  // sqrt
  if (!(Util::isPos(operand->data.f32) || Util::isZero(operand->data.f32) ||
        Util::isNaN(operand->data.f32))) {
    std::uint32_t nan = 0x7F800001;
    coreStack.push(*(float*)&nan);
  } else if (Util::isNaN(operand->data.f32) ||
             Util::isZero(operand->data.f32) ||
             Util::isInf(operand->data.f32)) {
    coreStack.push(operand->data.f32);
  } else {
  ...
  if (Util::isNaN(operand1->data.f32) || Util::isNaN(operand2->data.f32)) {
    ...
    if (Util::isPos(operand2->data.f32)) {
      ...
      coreStack.push(operand2->data.f32);
             ...
             Util::isZero(operand2->data.f32) &&
             !Util::eqSign(operand1->data.f32, operand2->data.f32)) {
    coreStack.push((float)-0.0);
  } else {
...
void Instruction::f64_abs(Stack& coreStack) {
  ...
  // abs
  coreStack.push(Util::isPos(operand->data.f64) ? operand->data.f64
                                                : -operand->data.f64);
  // Clean
  delete operand;
}
...
void Instruction::f64_ceil(Stack& coreStack) {
  ...
  // ceil
  if (Util::isNaN(operand->data.f64) || Util::isInf(operand->data.f64) ||
      Util::isZero(operand->data.f64)) {
    coreStack.push(operand->data.f64);
...
void Instruction::f64_sqrt(Stack& coreStack) {
  ...
  // sqrt
  if (!(Util::isPos(operand->data.f64) || Util::isZero(operand->data.f64) ||
        Util::isNaN(operand->data.f64))) {
    std::uint64_t nan = 0x7FF0000000000001;
    coreStack.push(*(double*)&nan);
  } else if (Util::isNaN(operand->data.f64) ||
             Util::isZero(operand->data.f64) ||
             Util::isInf(operand->data.f64)) {
    coreStack.push(operand->data.f64);
  } else {
  ...
  if (Util::isNaN(operand1->data.f64) || Util::isNaN(operand2->data.f64)) {
    ...
    if (Util::isPos(operand2->data.f64)) {
      ...
      coreStack.push(operand2->data.f64);
             ...
             Util::isZero(operand2->data.f64) &&
             !Util::eqSign(operand1->data.f64, operand2->data.f64)) {
    coreStack.push((double)-0.0);
  } else {
...
void Instruction::i32_trunc_s_f32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i32.trunc_s/f32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i32_trunc_u_f32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i32.trunc_u/f32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i32_trunc_s_f64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i32.trunc_s/f64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i32_trunc_u_f64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i32.trunc_u/f64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i64_extend_s_i32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i64.extend_s/i32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i64_extend_u_i32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i64.extend_u/i32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i64_trunc_s_f32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i64.trunc_s/f32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i64_trunc_u_f32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i64.trunc_u/f32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i64_trunc_s_f64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i64.trunc_s/f64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i64_trunc_u_f64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i64.trunc_u/f64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f32_convert_s_i32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f32.convert_s/i32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f32_convert_u_i32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f32.convert_u/i32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f32_convert_s_i64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f32.convert_s/i64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f32_convert_u_i64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f32.convert_u/i64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f32_demote_f64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f32.demote/f64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f64_convert_s_i32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f64.convert_s/i32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f64_convert_u_i32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f64.convert_u/i32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f64_convert_s_i64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f64.convert_s/i64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f64_convert_u_i64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f64.convert_u/i64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::f64_promote_f32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f64.promote/f32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
...
void Instruction::i32_reinterpret_f32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i32.reinterpret/f32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
  if (operand->type != f32) {
    throw Exception("[i32.reinterpret/f32] Operand type is not f32.",
                    coreStack);
  }
  // reinterpret
  coreStack.push(*(std::int32_t*)&operand->data.f32);
...
void Instruction::i64_reinterpret_f64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[i64.reinterpret/f64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
  if (operand->type != f64) {
    throw Exception("[i64.reinterpret/f64] Operand type is not f64.",
                    coreStack);
  }
  // reinterpret
  coreStack.push(*(std::int64_t*)&operand->data.f64);
...
void Instruction::f32_reinterpret_i32(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f32.reinterpret/i32] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
  if (operand->type != i32) {
    throw Exception("[f32.reinterpret/i32] Operand type is not i32.",
                    coreStack);
  }
  // reinterpret
  coreStack.push(*(float*)&operand->data.i32);
...
void Instruction::f64_reinterpret_i64(Stack& coreStack) {
  // Check operand
  if (coreStack.valueNum < 1) {
    throw Exception("[f64.reinterpret/i64] No enough value in the stack.",
                    coreStack);
  }
  // Pop operand
  Value* operand = (Value*)coreStack.pop().data;
  if (operand->type != i64) {
    throw Exception("[f64.reinterpret/i64] Operand type is not i64.",
                    coreStack);
  }
  // reinterpret
  coreStack.push(*(double*)&operand->data.i64);
