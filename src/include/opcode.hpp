...
enum Opcode : opcode_t {
    ...
    Call_ref = 0x14,
    // GC Struct operations (0xFB-prefixed)
    Struct_new = 0xFB00,
    ...
    Struct_get_u = 0xFB04,
    Struct_set = 0xFB05,
    // GC Array operations (0xFB-prefixed)
    Array_new = 0xFB06,
    ...
    // Reference type extensions (0xFB-prefixed)
    Ref_test = 0xFB14,
    ...
    // i31 scalar references (0xFB-prefixed)
    Ref_i31 = 0xFB1C,
    I31_get_s = 0xFB1D,
    I31_get_u = 0xFB1E,
    // GC type conversions (0xFB-prefixed)
