...
SemaTemplate(I32_load)
SemaTemplate(I64_load)
SemaTemplate(F32_load)
SemaTemplate(F64_load)
SemaTemplate(I32_load8_s)
SemaTemplate(I32_load8_u)
SemaTemplate(I32_load16_s)
SemaTemplate(I32_load16_u)
SemaTemplate(I64_load8_s)
SemaTemplate(I64_load8_u)
SemaTemplate(I64_load16_s)
SemaTemplate(I64_load16_u)
SemaTemplate(I64_load32_s)
SemaTemplate(I64_load32_u)
SemaTemplate(I32_store)
SemaTemplate(I64_store)
SemaTemplate(F32_store)
SemaTemplate(F64_store)
SemaTemplate(I32_store8)
SemaTemplate(I32_store16)
SemaTemplate(I64_store8)
SemaTemplate(I64_store16)
SemaTemplate(I64_store32)
