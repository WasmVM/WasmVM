...
public:
  enum {
    ...
    T__219 = 220, T__220 = 221, BlockComment = 222, LineComment = 223, WhiteSpace = 224, 
    Integer = 225, Unsigned = 226, Float = 227, String = 228, Id = 229, 
    NumType = 230, RefType = 231, HeapType = 232, Offset = 233, Align = 234
  };
  ...
  enum {
    ...
    RuleInstr = 45, RuleLabel = 46, RuleBlocktype = 47, RuleBlockinstr = 48, 
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<I64Context *> i64();
    I64Context* i64(size_t i);
  ...
  public:
    ...
    F32Context *f32();
    F64Context *f64();
    antlr4::tree::TerminalNode *HeapType();
    FuncidxContext *funcidx();
    GlobalidxContext *globalidx();
