...
uint32_t getLeb128_u32(uint8_t **ptr, uint8_t * const *max)
{
...
int32_t getLeb128_i32(uint8_t **ptr, uint8_t * const *max)
{
    int32_t ret = 0;
    for(int i=0; i < 5; ++i) {
        if(*ptr > *max) {
...
int64_t getLeb128_i64(uint8_t **ptr, uint8_t * const *max)
{
    int64_t ret = 0;
    for(int i=0; i < 10; i++) {
        if(*ptr > *max) {
