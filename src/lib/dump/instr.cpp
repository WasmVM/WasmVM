...
#define MemoryInstr(T, S) \
    ...
    AtomicInstr(WasmVM::Instr::I32_trunc_sat_f32_s, "i32.trunc_sat_f32.s")
    AtomicInstr(WasmVM::Instr::I32_trunc_sat_f32_u, "i32.trunc_sat_f32.u")
    AtomicInstr(WasmVM::Instr::I32_trunc_sat_f64_s, "i32.trunc_sat_f64.s")
    AtomicInstr(WasmVM::Instr::I32_trunc_sat_f64_u, "i32.trunc_sat_f64.u")
    AtomicInstr(WasmVM::Instr::I64_trunc_sat_f32_s, "i64.trunc_sat_f32.s")
    AtomicInstr(WasmVM::Instr::I64_trunc_sat_f32_u, "i64.trunc_sat_f32.u")
    AtomicInstr(WasmVM::Instr::I64_trunc_sat_f64_s, "i64.trunc_sat_f64.s")
    AtomicInstr(WasmVM::Instr::I64_trunc_sat_f64_u, "i64.trunc_sat_f64.u")
