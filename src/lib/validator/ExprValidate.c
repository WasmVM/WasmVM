    ...
    for(size_t i = 0; i < expr->length; ++i) {
        ...
        switch (instr->opcode) {
            ...
            case Op_call_indirect:
                ...
                break;
            case Op_drop:
                result = validate_Instr_drop((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_select:
                result = validate_Instr_select((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_get_local:
                result = validate_Instr_get_local((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_set_local:
                result = validate_Instr_set_local((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_tee_local:
                result = validate_Instr_tee_local((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_get_global:
                result = validate_Instr_get_global((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_set_global:
                result = validate_Instr_set_global((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_load:
            case Op_i64_load:
            case Op_f32_load:
            case Op_f64_load:
                result = validate_Instr_load((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_load8_s:
            case Op_i32_load8_u:
            ...
            case Op_i64_load32_u:
                result = validate_Instr_loadN((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_store:
            case Op_i64_store:
            case Op_f32_store:
            case Op_f64_store:
                result = validate_Instr_store((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_store8:
            case Op_i32_store16:
            case Op_i64_store8:
            case Op_i64_store16:
            case Op_i64_store32:
                result = validate_Instr_storeN((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_memory_size:
                result = validate_Instr_memory_size((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_memory_grow:
                result = validate_Instr_memory_grow((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_const:
            case Op_i64_const:
            case Op_f32_const:
            case Op_f64_const:
                result = validate_Instr_const((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_eqz:
                result = validate_Instr_testop((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_eq:
            case Op_i32_ne:
            case Op_i32_lt_s:
            ...
            case Op_i32_ge_s:
            case Op_i32_ge_u:
                result = validate_Instr_relop((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i64_eqz:
                result = validate_Instr_testop((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            ...
            case Op_i32_ctz:
            case Op_i32_popcnt:
                result = validate_Instr_unop((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i32_add:
            case Op_i32_sub:
            case Op_i32_mul:
            ...
            case Op_i32_rotl:
            case Op_i32_rotr:
                result = validate_Instr_binop((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            case Op_i64_clz:
            case Op_i64_ctz:
            case Op_i64_popcnt:
            ...
            case Op_f64_promote_f32:
                result = validate_Instr_cvtop((WasmControlInstr*)instr, context, opds, ctrls);
                break;
            default:
                clean(opds, ctrls);
                return -1;
