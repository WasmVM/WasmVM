...
/*
 * This function applys runtime_i32_gt_s() unittest and return the result of runtime_i32_gt_s().
 */
int32_t i32_gt_s_check(Stack* stack, int32_t value_1, int32_t value_2)
{
    Value *check = NULL;
...
SKYPAT_F(Runtime_i32_gt_s, regular)
{
    ...
    // case 1: 20 > 3
    check_value = i32_gt_s_check(stack, 20, 3);
