...
/*
 * This function applys runtime_i64_lt_u() unittest and check the result of runtime_i64_lt_u().
 */
void i64_lt_u_check(Stack stack, int64_t value_1, int64_t value_2, int64_t expected)
{
    Value *check = NULL;
...
SKYPAT_F(Runtime_i64_lt_u, regular)
{
