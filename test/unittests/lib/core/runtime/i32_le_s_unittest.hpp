...
/*
 * This function applys runtime_i32_le_s() unittest and check the result of runtime_i32_le_s().
 */
void i32_le_s_check(Stack stack, int32_t value_1, int32_t value_2, int32_t expected)
{
    Value *check = NULL;
