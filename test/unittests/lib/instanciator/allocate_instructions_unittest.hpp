...
SKYPAT_F(allocate_instructions, control)
{
    ...
    *index2 = 4;
    ...
    list_t body = new_list((void(*)(void*))free_WasmControlInstr);
...
SKYPAT_F(allocate_instructions, parametric)
{
    ...
    list_t body = new_list((void(*)(void*))free_WasmParametricInstr);
    list_push_back(body, instr);
...
SKYPAT_F(allocate_instructions, memory)
{
    ...
    list_t body = new_list((void(*)(void*))free_WasmMemoryInstr);
    list_push_back(body, instr);
...
SKYPAT_F(allocate_instructions, numeric)
{
    ...
    list_t body = new_list((void(*)(void*))free_WasmNumericInstr);
    list_push_back(body, instr);
