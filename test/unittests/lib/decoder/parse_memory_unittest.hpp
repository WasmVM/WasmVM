...
SKYPAT_F(decoder_parse_variable, memory_size)
{
    ...
    WasmMemoryInstr* instr = (WasmMemoryInstr*)func->body->at(func->body, 0);
...
SKYPAT_F(decoder_parse_variable, i32_load_x)
{
    ...
    instr = (WasmMemoryInstr*)func->body->at(func->body, 1);
    EXPECT_EQ(instr->parent.opcode, Op_i32_load8_s);
    EXPECT_EQ(instr->align, 1);
    EXPECT_EQ(instr->offset, 4);
    instr = (WasmMemoryInstr*)func->body->at(func->body, 2);
    EXPECT_EQ(instr->parent.opcode, Op_i32_load8_u);
    EXPECT_EQ(instr->align, 1);
    EXPECT_EQ(instr->offset, 4);
    instr = (WasmMemoryInstr*)func->body->at(func->body, 3);
    EXPECT_EQ(instr->parent.opcode, Op_i32_load16_s);
    EXPECT_EQ(instr->align, 1);
    EXPECT_EQ(instr->offset, 4);
    instr = (WasmMemoryInstr*)func->body->at(func->body, 4);
...
SKYPAT_F(decoder_parse_variable, i64_load_x)
{
    ...
    EXPECT_EQ(instr->align, 1);
    EXPECT_EQ(instr->offset, 4);
    instr = (WasmMemoryInstr*)func->body->at(func->body, 5);
    EXPECT_EQ(instr->parent.opcode, Op_i64_load32_s);
    EXPECT_EQ(instr->align, 1);
    EXPECT_EQ(instr->offset, 4);
    instr = (WasmMemoryInstr*)func->body->at(func->body, 6);
